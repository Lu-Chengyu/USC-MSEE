...
class Database {
    ...
    async getPlayer(pid) {
        let result;
        try {
            //console.log(await this.db.collection(this.player).find({}).toArray())
            //console.log(pid)
    ...
    async getPlayers() {
        ...
        try {
            ...
            //console.log(result)
            //console.log(this.db.collection(this.match))
    ...
    async getSomeMatches(is_active) {
        ...
        try {
            if (is_active == "true") {
                //result = await this.db.collection(this.match).find({'is_active':true}).toArray()
                ...
                //result = await this.db.collection(this.match).find({'is_active':false}).toArray()
            }
            result = await this.normalizedMatch(result)
            result.sort((a, b) => {
                if (a.prize_usd_cents < b.prize_usd_cents) {
