...
//***********************************************************************************************
  void TravelingTrojan_Brute_force_helper(std::vector<std::vector<std::string>> &recorded_path, 
...
//***********************************************************************************************
  void TravelingTrojan_Backtracking_helper(std::vector<std::vector<std::string>> &recorded_path, 
  std::unordered_map<std::string, bool> &visited, 
  double &min_dis, std::vector<std::string> &min_path, 
  double &cur_dis, std::vector<std::string> &cur_path);
//***********************************************************************************************
...
//***********************************************************************************************
  void TrojanPath_helper(std::string prev, std::pair<double, std::vector<std::vector<std::string>>> &min, 
...
//***********************************************************************************************
  ...
  bool CycleDetectionhelper(std::string root, std::map<std::string, bool> &visited, 
